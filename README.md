...
[Возможности](#возможности) | [Скриншоты](#скриншоты) | [Автоматизация](#автоматизация) | [Вывод на приборку](#вывод-на-приборку) | [AI Инсайты](#ai-инсайты) | [ABRP](#abrp--live-телеметрия) | [Установка](#установка) | [Сборка](#сборка-из-исходников) | [Релизы](https://github.com/AndyShaman/BYDMate/releases) | [Поддержать](SUPPORT.md)
...
Приложение работает **полностью локально** на головном устройстве DiLink 5.0 — никакие данные не покидают автомобиль. **Локальные инсайты** на дашборде считаются на устройстве без интернета. Опционально и только вручную можно включить: **облачные инсайты** через OpenRouter и **телеметрию** в A Better Route Planner.
