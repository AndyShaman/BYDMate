...
**Яндекс.Навигатор на приборку.** Правой звездой на руле навигация переносится на приборную панель и обратно на центральный экран. По умолчанию это Яндекс.Навигатор, но можно выбрать любое приложение. Подробнее в разделе «Навигатор на приборку».
...
| **Cluster** | Навигатор на приборку | Вывод навигации на приборную панель правой звездой руля |
...
### Управление правой звездой руля

- **Короткое нажатие правой звезды** переносит навигацию на приборку.
...
Откройте **Настройки → Приборка** и включите тумблер «Навигатор на приборку правой звездой». Приложение само активирует нужный сервис (требуется включённая ADB-отладка, см. «Установка»), вручную ничего настраивать не надо.
...
По умолчанию на приборку выводится Яндекс.Навигатор. Под тумблером включения есть выбор приложения: можно указать любое установленное (другой навигатор, медиаплеер и т.д.). Новый выбор применяется при следующем нажатии звезды.
