...
class FullMigrationChainTest {
    ...
    private val dbName = "migration-chain-5-21.db"
    ...
    /** Oldest exported schema (5) through current (21) on PRODUCTION migrations only —
     *  validates every step against the exported schema JSONs, like a v1.x-era user
     *  updating straight to today's build. */
    @Test
    fun `full chain 5 to 21 on production migrations`() {
        ...
        helper.runMigrationsAndValidate(
            ...
            AppModule.MIGRATION_17_18, AppModule.MIGRATION_18_19,
            AppModule.MIGRATION_19_20, AppModule.MIGRATION_20_21,
        ).close()
    }
}
