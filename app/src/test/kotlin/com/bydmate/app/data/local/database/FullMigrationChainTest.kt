...
class FullMigrationChainTest {
    ...
    private val dbName = "migration-chain-5-20.db"
    ...
    /** Oldest exported schema (5) through current (20) on PRODUCTION migrations only —
     *  validates every step against the exported schema JSONs, like a v1.x-era user
     *  updating straight to today's build. */
    @Test
    fun `full chain 5 to 20 on production migrations`() {
